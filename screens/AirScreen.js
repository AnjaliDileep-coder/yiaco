...
const ProductScreen = () => {
    ...
    const [product, setProduct] = useState([
        ...
        { name: 'Sthethescope', image: require("../assets/sthethescope.jpg"), price: '$ 475', description: 'The stethoscope is an acoustic medical device for auscultation, or listening to internal sounds of an animal or human body.', id: '3' },
        ...
        { name: 'KN95 Mask', image: require("../assets/KN95_mask.jpeg"), price: '$ 100', description: 'The KN95 Respirator Mask is worn to protect the wearer from viruses, bacteria, pollen and other particles', id: '5' },
        ...
        { name: 'sphygmomanometer', image: require("../assets/bp_monitor.jpg"), price: '$ 700', description: 'A sphygmomanometer, also known as a blood pressure monitor, or blood pressure gauge, is a device used to measure blood pressure, composed of an inflatable cuff to collapse and then release the artery under the cuff in a controlled manner, and a mercury or aneroid manometer to measure the pressure.', id: '8' },
        { name: 'Wheel Chair', image: require("../assets/wheel_chair.jpg"), price: '$ 350', description: 'A wheelchair is a chair with wheels, used when walking is difficult or impossible due to illness, injury, problems related to old age, or disability.', id: '9' },
        { name: 'Microscope', image: require("../assets/microscope.jpg"), price: '$ 900', description: 'A microscope is a laboratory instrument used to examine objects that are too small to be seen by the naked eye.', id: '10' },
        ...
        { name: 'Therapy Equipment', image: require("../assets/therapy_equipment.jpg"), price: '$ 750', description: 'Treadmills, exercise bikes, pedal exerciser or elliptical trainer are some of the most common types of physiotherapy equipments used in most of the therapy clinics and hospitals.', id: '14' },
    ]);
    return (
        <View>
            <FlatList
